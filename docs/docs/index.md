...
- **Failure notifications**: Get alerted via email or Slack when jobs fail
...
- [Notifications](self-hosting/notifications) - Configure failure alerts via email or Slack
