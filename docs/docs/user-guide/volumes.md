...
:::note
SMB support uses the `smbclient` extension bundled in the official Databasement Docker image. If you build a custom image, make sure the SMB client is installed. Connectivity is over SMB2/SMB3.
:::
