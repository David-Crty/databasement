<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <x-input
            wire:model="config.access_key_id"
        ...
        <x-password
            wire:model="config.secret_access_key"
    ...
    <div x-data="{ showAdvanced: false }">
        ...
        <div x-show="showAdvanced" x-collapse class="mt-3 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-input
                    wire:model="config.custom_endpoint"
                ...
                <x-input
                    wire:model="config.public_endpoint"
            ...
            <x-checkbox
                wire:model="config.use_path_style_endpoint"
            ...
            <x-input
                wire:model="config.custom_role_arn"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-input
                    wire:model="config.role_session_name"
                ...
                <x-input
                    wire:model="config.sts_endpoint"
